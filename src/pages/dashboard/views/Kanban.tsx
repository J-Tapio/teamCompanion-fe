...
//TODO: Check implementation. Card move from table to another works but inside the table re-ordering seems incoherent/malfunctional.
    ...
    <Grid item xs={12}>
      <Stack spacing={5}>
        ...
        <Typography variant="h6" fontWeight="700" gutterBottom>
          Feel free to move tasks between To Do and Done tables. Will implement
          possibility to add/remove tasks later.
        </Typography>
