...
import { setEventDate, hasError, getEvents, ICreatedActivity } from 'store/slices/events';
// Components
...
export default function Calendar() {
  ...
  const [eventInFocus, setEventInFocus] = useState<ICreatedActivity | null>(null);
  ...
  return (
    <Grid item xs={12} visibility={membersSelected ? 'visible' : 'hidden'}>
      ...
      { eventInFocus &&
        <EventInfoDialog eventInfoOpen={eventInfoOpen} setEventInfoOpen={setEventInfoOpen} eventInfo={eventInFocus}/>
      }
